...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          WELCOME TO VIEW ALL AUDITED DATA LOG 
          </marquee>
          DETAILS</p>
          <div class="clr"></div>
          <div class="img"></div>
	...
	<td width="223"><div align="center" class="style2">Audit Date and Time</div></td>
	<td width="223"><div align="center" class="style2">Status</div></td>
	</tr>
	<%	
...
s6=rs.getString(4);
		...
		<tr><td><div align="center"><%=s2%></div></td><td><div align="center"><%=s7%></div></td><td><div align="center"><%=s77%></div></td><td><div align="center"><%=s6%></div></td></tr>	<br />
<%
...
%>
          <p>          
          <p><a href="A_MainPage.jsp">Back</a>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
                   <li class="active"><a href="O_MainPage.jsp"><span>Home Page</span></a></li>
								 ...
								 <li><a href="A_ViewAllFiles.jsp"><span>View All Files Meta Data</span></a></li>
								  <li><a href="A_ViewAllFiles.jsp"><span>View All Data Auditing Report</span></a></li>
