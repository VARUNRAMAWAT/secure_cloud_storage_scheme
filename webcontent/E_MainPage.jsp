...
<head>
<title>End User::A Fog centric Secure Cloud Storage Scheme</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost">WELCOME TO END USER :: ->  <%=application.getAttribute("uname") %>  </p>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
				   ...
				   <li><a href="E_SearchFile.jsp"><span>Search File </span></a></li>
