...
<head>
<title>View File Bloak Details::A Fog centric Secure Cloud Storage Scheme</title>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <h1 class="style1">View File Blocks</h1>
      
          <iframe width="755" height="500" src="vb.jsp"></iframe>
