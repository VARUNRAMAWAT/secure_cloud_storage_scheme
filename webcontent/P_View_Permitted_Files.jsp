...
.style3 {color: #FFFF00; font-weight: bold; font-style: italic; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost"><marquee behavior='scroll'>
          WELCOME TO PROXY --- <span class="style3">VIEW ALL PERMITTED FILES TO CLOUD SERVER AND AUDITOR
          </span>
          </marquee></p>
	...
	<td width="223"><div align="center" class="style1">Date and Time</div></td>
	</tr>
	<%	
...
%>
          ...
          <p><a href="P_MainPage.jsp">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
