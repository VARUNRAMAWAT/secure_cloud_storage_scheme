...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost"><marquee behavior="alternate">WELCOME TO AUDITOR--- View all Files Blocks Meta Data</marquee> </p>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
        <div class="article">
          <h2>dsgdfgsfdgsdf</h2>
          <p>&nbsp;</p>
          <p><a href="A_MainPage.jsp">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
                   <li class="active"><a href="O_MainPage.jsp"><span>Home Page</span></a></li>
								 ...
								 <li><a href="O_ViewBlocks.jsp"><span>View All Files Meta Data</span></a></li>
