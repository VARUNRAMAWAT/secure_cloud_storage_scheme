...
<head>
<title>Search File::A Fog centric Secure Cloud Storage Scheme</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost">SEARCH FILES </p>
          <div class="clr"></div>
        </div>
        <div class="article">
          <form id="form1" name="form1" method="post" action="E_SearchFile1.jsp">
            <p>&nbsp;</p>
            <table width="607" border="1">
              <tr>
                <td><span class="style1">Enter your Keyword To Seach Files </span></td>
                <td><input type="text" name="keyword"  placeholder="Enter Your Keyword"/></td>
              </tr>
              <tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
				   ...
				   <li><a href="E_RequestFile.html"><span>Search File </span></a></li>
