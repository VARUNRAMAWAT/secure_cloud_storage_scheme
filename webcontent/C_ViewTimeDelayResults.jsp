...
<head>
<title>Time Delay Results::A Fog centric Secure Cloud Storage Scheme</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html">A Fog centric Secure Cloud Storage Scheme</strong></a></h1>
      </div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
           <h1 align="center" class="style1">View Time Delay Results</h1>


           <iframe src="Results1.jsp" style="border:3px;" width="650" height="700"></iframe>
