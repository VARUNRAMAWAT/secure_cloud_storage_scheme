  ...
  <div class="content">
    <div class="content_resize">
      ...
      <p></p>
	    ...
	    <div class="clr"></div>
		   <p>&nbsp;</p>
        <p class="style5"> <%=(String)application.getAttribute("fname")%> <span class="style6">is Attacked By</span> <%=(String)application.getAttribute("attacker")%></p>
