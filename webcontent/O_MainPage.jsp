...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p class="infopost">WELCOME TO DATA OWNER ::-> <%=application.getAttribute("oname") %> </p>
          <div class="clr"></div>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
                   <li class="active"><a href="O_MainPage.jsp"><span>Home Page</span></a></li>
				    ...
				    <li><a href="O_ViewBlocks.jsp"><span>View All Files</span></a></li>
          <li><a href="O_UploadFile.html"><span>Upload File </span></a></li>

          
          <li><a href="O_VerifyBlock.html"><span>Block Verification</span></a></li>
